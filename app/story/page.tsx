...
const books = [
  { slug: 'harry-potter', title: 'Harry Potter', subtitle: 'The Wizarding World', author: 'A magical mystery', theme: 'magic', mark: 'ϟ', description: 'Take a turn at the edge of a world where every choice carries a little magic.' },
  { slug: 'game-of-thrones', title: 'Game of Thrones', subtitle: 'A Song of Ice & Fire', author: 'A tale of crowns', theme: 'thrones', mark: '♛', description: 'Step into a kingdom of alliances, ambition, and impossible decisions.' },
  { slug: 'fight-club', title: 'Fight Club', subtitle: 'Rules are made to break', author: 'An untold perspective', theme: 'fight', mark: '◒', description: 'Follow a path through identity, rebellion, and a very different kind of freedom.' },
  { slug: 'shawshank-redemption', title: 'The Shawshank Redemption', subtitle: 'Hope is a good thing', author: 'A story of resilience', theme: 'shawshank', mark: '↗', description: 'Find the moments where patience, courage, and hope change the ending.' },
]
